  ...
  document.getElementById("app").innerHTML = `
    <div class="screen auth-screen">
      <form id="register-form" class="auth-box">
        ...
        <p class="auth-link">Already have an account. <span id="link-to-login">Iniciar sessão</span></p>
      </form>
    </div>
  `;
};
...
export const bindLinkToLogin = (handler) => {
  document.getElementById("link-to-login").addEventListener("click", handler);
};
  ...
  document.getElementById("app").innerHTML = `
    <div class="screen auth-screen">
      <form id="login-form" class="auth-box">
        ...
        <p class="auth-link">Create an account. <span id="link-to-register">Criar conta</span></p>
      </form>
    </div>
  `;
};
...
export const bindLinkToRegister = (handler) => {
  document.getElementById("link-to-register").addEventListener("click", handler);
};
